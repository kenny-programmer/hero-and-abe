...
const faqs: FAQItem[] = [
  {
    ...
    answer:
      "Please RSVP by June 4, 2025. You can RSVP through the link provided in your invitation.",
  },
  {
    question: "What time should guests arrive?",
    answer:
      "We recommend guests arrive 30 minutes before the ceremony starts to allow time for seating.",
  },
  {
    question: "Is there a dress code?",
    answer:
      "Yes, we request semi-formal attire. Ladies in dresses or elegant pantsuits, and gentlemen in suits or blazers with dress pants.",
  },
  {
    question: "Will the ceremony and reception be indoors or outdoors?",
    answer:
      "The ceremony will be held outdoors in the garden area, while the reception will take place in the main hall.",
  },
  {
      ...
      <div className="max-w-3xl mx-auto divide-y">
        {faqs.map((faq, index) => (
          <div key={index} className="py-6">
            ...
            >
              <h3 className="text-lg font-medium text-wedding-text">
                {faq.question}
              </h3>
              <span>
                {openIndex === index ? (
